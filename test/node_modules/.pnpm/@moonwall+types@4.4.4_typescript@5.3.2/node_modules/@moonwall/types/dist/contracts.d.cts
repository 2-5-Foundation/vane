 ...
 */
type MoonwallContract<TAbi extends Abi> = {
    abi: TAbi;
    bytecode: `0x${string}`;
 ...
 */
type CompiledContract<TAbi extends Abi> = {
    byteCode: `0x${string}`;
 ...
 */
type ContractObject<TAbi extends Abi> = {
    abi: TAbi;
    devdoc: any;
    evm: any;
    ewasm: any;
 ...
 */
type ContractDeploymentOptions = DeepPartial<Omit<DeployContractParameters, "abi" | "bytecode" | "privateKey">> & {
    privateKey?: `0x${string}`;
    args?: any[];
    txnType?: TransactionType;
};

export type { CompiledContract, ContractDeploymentOptions, ContractObject, MoonwallContract };
