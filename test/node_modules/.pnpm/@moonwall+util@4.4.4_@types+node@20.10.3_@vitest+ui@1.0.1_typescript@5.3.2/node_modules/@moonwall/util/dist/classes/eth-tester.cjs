...
var eth_tester_exports = {};
__export(eth_tester_exports, {
  DEFAULT_TRANSACTION: () => DEFAULT_TRANSACTION,
  EthTester: () => EthTester
});
module.exports = __toCommonJS(eth_tester_exports);
...
var EthTester = class {
  ...
  genSignedContractDeployment = async (contractCreation, options = DEFAULT_TRANSACTION) => {
    const factory = new import_ethers.ContractFactory(contractCreation.abi, contractCreation.byteCode);
    return await this.genSignedTransaction({
      ...options,
