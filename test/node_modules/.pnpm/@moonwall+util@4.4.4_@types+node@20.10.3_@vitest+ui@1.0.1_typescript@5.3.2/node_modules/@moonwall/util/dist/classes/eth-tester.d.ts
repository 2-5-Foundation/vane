...
declare const DEFAULT_TRANSACTION: {};
/**
...
declare class EthTester {
     ...
     * });
     */
    constructor(web3: Web3, privateKey: string, logger: Debugger, type?: "Legacy" | "EIP2930" | "EIP1559");
    /**
     ...
     * });
     */
    genSignedTransaction: (options?: TransactionOptions, txType?: "Legacy" | "EIP2930" | "EIP1559") => Promise<string>;
    /**
     ...
     * @returns Signed transaction
     */
    genSignedTransfer: (to: string, value: number | string | bigint, options?: TransactionOptions) => Promise<string>;
    /**
     ...
     * @returns Signed transaction
     */
    genSignedContractDeployment: (contractCreation: ContractCreation, options?: TransactionOptions) => Promise<string>;
    /**
     ...
     */
    sendSignedTransaction: (rawTransaction: string | PromiseLike<string>) => Promise<JsonRpcResponse>;
}

export { type ContractCreation, DEFAULT_TRANSACTION, EthTester, type TransactionOptions };
