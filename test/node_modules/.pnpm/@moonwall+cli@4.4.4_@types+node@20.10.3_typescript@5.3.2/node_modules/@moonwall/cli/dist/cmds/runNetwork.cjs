...
var runNetwork_exports = {};
__export(runNetwork_exports, {
  runNetworkCmd: () => runNetworkCmd
});
module.exports = __toCommonJS(runNetwork_exports);
...
Please select a choice: `,
  ...
  if (!args.GrepTest) {
    await import_inquirer2.default.prompt(questions.find(({ name }) => name == "NetworkStarted"));
  } else {
    process.env.MOON_RECYCLE = "true";
  ...
  mainloop:
    for (; ; ) {
      const choice = await import_inquirer2.default.prompt(questions.find(({ name }) => name == "MenuChoice"));
      ...
      switch (choice.MenuChoice) {
        ...
        case 5:
          ...
          break;
        case 6: {
          const quit = await import_inquirer2.default.prompt(questions.find(({ name }) => name == "Quit"));
          if (quit.Quit === true) {
            break mainloop;
          }
          break;
