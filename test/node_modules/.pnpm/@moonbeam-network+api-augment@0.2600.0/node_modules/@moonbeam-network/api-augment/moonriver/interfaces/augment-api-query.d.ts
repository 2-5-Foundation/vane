...
import type { CumulusPalletDmpQueueConfigData, CumulusPalletDmpQueuePageIndexData, CumulusPalletParachainSystemCodeUpgradeAuthorization, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletParachainSystemUnincludedSegmentAncestor, CumulusPalletParachainSystemUnincludedSegmentSegmentTracker, CumulusPalletXcmpQueueInboundChannelDetails, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, EthereumBlock, EthereumReceiptReceiptV3, EthereumTransactionTransactionV2, FpRpcTransactionStatus, FrameSupportDispatchPerDispatchClassWeight, FrameSupportPreimagesBounded, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, MoonriverRuntimeRuntimeHoldReason, MoonriverRuntimeXcmConfigAssetType, NimbusPrimitivesNimbusCryptoPublic, PalletAssetManagerAssetInfo, PalletAssetsApproval, PalletAssetsAssetAccount, PalletAssetsAssetDetails, PalletAssetsAssetMetadata, PalletAuthorMappingRegistrationInfo, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesIdAmount, PalletBalancesReserveData, PalletCollectiveVotes, PalletConvictionVotingVoteVoting, PalletCrowdloanRewardsRewardInfo, PalletDemocracyMetadataOwner, PalletDemocracyReferendumInfo, PalletDemocracyVoteThreshold, PalletDemocracyVoteVoting, PalletEvmCodeMetadata, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletMoonbeamOrbitersCollatorPoolInfo, PalletMultisigMultisig, PalletParachainStakingAutoCompoundAutoCompoundConfig, PalletParachainStakingBond, PalletParachainStakingCandidateMetadata, PalletParachainStakingCollatorSnapshot, PalletParachainStakingDelayedPayout, PalletParachainStakingDelegationRequestsScheduledRequest, PalletParachainStakingDelegations, PalletParachainStakingDelegator, PalletParachainStakingInflationInflationInfo, PalletParachainStakingParachainBondConfig, PalletParachainStakingRoundInfo, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletRandomnessRandomnessResult, PalletRandomnessRequestState, PalletRandomnessRequestType, PalletReferendaReferendumInfo, PalletSchedulerScheduled, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletXcmQueryStatus, PalletXcmRemoteLockedFungibleRecord, PalletXcmTransactorRelayIndicesRelayChainIndices, PalletXcmTransactorRemoteTransactInfoWithMaxWeight, PalletXcmVersionMigrationStage, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV5AbridgedHostConfiguration, PolkadotPrimitivesV5PersistedValidationData, PolkadotPrimitivesV5UpgradeGoAhead, PolkadotPrimitivesV5UpgradeRestriction, SpRuntimeDigest, SpTrieStorageProof, SpWeightsWeightV2Weight, StagingXcmV3MultiLocation, StagingXcmVersionedAssetId, StagingXcmVersionedMultiLocation } from "@polkadot/types/lookup";
...
declare module "@polkadot/api-base/types/storage" {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        assetManager: {
            ...
            /**
             * Stores the counter of the number of local assets that have been created so far This value
             * can be used to salt the creation of an assetId, e.g., by hashing it. This is particularly
             * useful for cases like moonbeam where letting users choose their assetId would result in
             * collision in the evm side.
             */
            localAssetCounter: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
            /**
             * Local asset deposits, a mapping from assetId to a struct holding the creator (from which
             * the deposit was reserved) and the deposit amount
             */
        ...
        authorInherent: {
            ...
            /**
             * The highest slot that has been seen in the history of this chain. This is a
        ...
        democracy: {
            /**
             * A record of who vetoed what. Maps proposal hash to a possible existent block number (until
             * when it may not be resubmitted) and who vetoed it.
             */
            blacklist: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<ITuple<[u32, Vec<AccountId20>]>>>, [
                H256
            ]> & QueryableStorageEntry<ApiType, [H256]>;
             ...
             */
            depositOf: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ITuple<[Vec<AccountId20>, u128]>>>, [
                u32
            ]> & QueryableStorageEntry<ApiType, [u32]>;
            /** True if the last referendum tabled was submitted externally. False if it was a public proposal. */
            lastTabledWasExternal: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
            /**
             * The lowest referendum index representing an unbaked referendum. Equal to `ReferendumCount`
            ...
            publicProps: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, FrameSupportPreimagesBounded, AccountId20]>>>, [
            ]> & QueryableStorageEntry<ApiType, []>;
             ...
             * recorded. The second item is the total amount of delegations, that will be added.
             *
             * TWOX-NOTE: SAFE as `AccountId`s are crypto hashes anyway.
             */
            votingOf: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<PalletDemocracyVoteVoting>, [
                AccountId20
            ]> & QueryableStorageEntry<ApiType, [AccountId20]>;
            /** Generic query */
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        identity: {
             ...
             */
            identityOf: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletIdentityRegistration>>, [
                AccountId20
            ]> & QueryableStorageEntry<ApiType, [AccountId20]>;
            /**
        ...
        parachainStaking: {
            ...
            staked: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<u128>, [
                u32
            ]> & QueryableStorageEntry<ApiType, [u32]>;
        ...
        polkadotXcm: {
             ...
             *
             * Key is the blake2 256 hash of (origin, versioned `MultiAssets`) pair. Value is the number
             * of times this pair has been trapped (usually just 1 if it exists at all).
             */
            ...
            lockedFungibles: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<Vec<ITuple<[u128, StagingXcmVersionedMultiLocation]>>>>, [
                AccountId20
            ]> & QueryableStorageEntry<ApiType, [AccountId20]>;
            /** The ongoing queries. */
            ...
            remoteLockedFungibles: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array, arg3: StagingXcmVersionedAssetId | {
                V3: any;
            } | string | Uint8Array) => Observable<Option<PalletXcmRemoteLockedFungibleRecord>>, [
                u32,
                AccountId20,
                StagingXcmVersionedAssetId
            ]> & QueryableStorageEntry<ApiType, [u32, AccountId20, StagingXcmVersionedAssetId]>;
            /**
        ...
        xcmTransactor: {
             ...
             * weight to fee
             */
            destinationAssetFeePerSecond: AugmentedQuery<ApiType, (arg: StagingXcmV3MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<u128>>, [
             ...
             */
            transactInfoWithWeightLimit: AugmentedQuery<ApiType, (arg: StagingXcmV3MultiLocation | {
                parents?: any;
                interior?: any;
