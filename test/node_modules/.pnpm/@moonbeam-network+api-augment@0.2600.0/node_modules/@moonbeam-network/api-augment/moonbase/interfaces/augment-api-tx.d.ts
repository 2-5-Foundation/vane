...
import type { CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionTransactionV2, FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime, MoonbaseRuntimeAssetConfigAssetRegistrarMetadata, MoonbaseRuntimeOriginCaller, MoonbaseRuntimeProxyType, MoonbaseRuntimeXcmConfigAssetType, MoonbaseRuntimeXcmConfigCurrencyId, MoonbaseRuntimeXcmConfigTransactors, NimbusPrimitivesNimbusCryptoPublic, PalletConvictionVotingConviction, PalletConvictionVotingVoteAccountVote, PalletDemocracyConviction, PalletDemocracyMetadataOwner, PalletDemocracyVoteAccountVote, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletMultisigTimepoint, PalletXcmTransactorCurrencyPayment, PalletXcmTransactorHrmpOperation, PalletXcmTransactorTransactWeights, SpRuntimeMultiSignature, SpWeightsWeightV2Weight, StagingXcmV2OriginKind, StagingXcmV3MultiLocation, StagingXcmV3WeightLimit, StagingXcmVersionedMultiAsset, StagingXcmVersionedMultiAssets, StagingXcmVersionedMultiLocation, StagingXcmVersionedXcm, XcmPrimitivesEthereumXcmEthereumXcmTransaction } from "@polkadot/types/lookup";
...
declare module "@polkadot/api-base/types/submittable" {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        assetManager: {
            ...
            removeSupportedAsset: AugmentedSubmittable<(assetType: MoonbaseRuntimeXcmConfigAssetType | {
                Xcm: any;
            } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                MoonbaseRuntimeXcmConfigAssetType,
                u32
            ...
            setAssetUnitsPerSecond: AugmentedSubmittable<(assetType: MoonbaseRuntimeXcmConfigAssetType | {
                Xcm: any;
        ...
        proxy: {
            ...
            addProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonbaseRuntimeProxyType | "Any" | "NonTransfer" | "Governance" | "Staking" | "CancelProxy" | "Balances" | "AuthorMapping" | "IdentityJudgement" | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                AccountId20,
            ...
            createPure: AugmentedSubmittable<(proxyType: MoonbaseRuntimeProxyType | "Any" | "NonTransfer" | "Governance" | "Staking" | "CancelProxy" | "Balances" | "AuthorMapping" | "IdentityJudgement" | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                MoonbaseRuntimeProxyType,
                u32,
                u16
            ]>;
            ...
            removeProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonbaseRuntimeProxyType | "Any" | "NonTransfer" | "Governance" | "Staking" | "CancelProxy" | "Balances" | "AuthorMapping" | "IdentityJudgement" | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                AccountId20,
                MoonbaseRuntimeProxyType,
                u32
            ]>;
        ...
        referenda: {
            ...
            /** See [`Pallet::submit`]. */
            submit: AugmentedSubmittable<(proposalOrigin: MoonbaseRuntimeOriginCaller | {
                system: any;
            } | {
                Void: any;
            } | {
        ...
        utility: {
            ...
            dispatchAs: AugmentedSubmittable<(asOrigin: MoonbaseRuntimeOriginCaller | {
                system: any;
            } | {
                Void: any;
            } | {
        ...
        xcmTransactor: {
            ...
            transactThroughDerivative: AugmentedSubmittable<(dest: MoonbaseRuntimeXcmConfigTransactors | "Relay" | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, fee: PalletXcmTransactorCurrencyPayment | {
                currency?: any;
                feeAmount?: any;
        ...
        xTokens: {
            /** See [`Pallet::transfer`]. */
            transfer: AugmentedSubmittable<(currencyId: MoonbaseRuntimeXcmConfigCurrencyId | {
                SelfReserve: any;
            } | {
                ForeignAsset: any;
            } | {
            ...
            transferMulticurrencies: AugmentedSubmittable<(currencies: Vec<ITuple<[MoonbaseRuntimeXcmConfigCurrencyId, u128]>> | [
                (MoonbaseRuntimeXcmConfigCurrencyId | {
                    SelfReserve: any;
                } | {
                    ForeignAsset: any;
            ...
            transferWithFee: AugmentedSubmittable<(currencyId: MoonbaseRuntimeXcmConfigCurrencyId | {
                SelfReserve: any;
            } | {
                ForeignAsset: any;
            } | {
