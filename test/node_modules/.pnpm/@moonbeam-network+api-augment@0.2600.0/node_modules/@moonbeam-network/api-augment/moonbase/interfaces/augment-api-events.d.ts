...
import type { EthereumLog, EvmCoreErrorExitReason, FrameSupportDispatchDispatchInfo, FrameSupportDispatchPostDispatchInfo, FrameSupportPreimagesBounded, FrameSupportTokensMiscBalanceStatus, MoonbaseRuntimeAssetConfigAssetRegistrarMetadata, MoonbaseRuntimeProxyType, MoonbaseRuntimeXcmConfigAssetType, NimbusPrimitivesNimbusCryptoPublic, PalletConvictionVotingTally, PalletDemocracyMetadataOwner, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletMultisigTimepoint, PalletParachainStakingDelegationRequestsCancelledScheduledRequest, PalletParachainStakingDelegatorAdded, PalletXcmTransactorHrmpOperation, PalletXcmTransactorRemoteTransactInfoWithMaxWeight, SessionKeysPrimitivesVrfVrfCryptoPublic, SpRuntimeDispatchError, SpRuntimeDispatchErrorWithPostInfo, SpWeightsWeightV2Weight, StagingXcmV3MultiAsset, StagingXcmV3MultiLocation, StagingXcmV3MultiassetMultiAssets, StagingXcmV3Response, StagingXcmV3TraitsError, StagingXcmV3TraitsOutcome, StagingXcmV3Xcm, StagingXcmVersionedMultiAssets, StagingXcmVersionedMultiLocation } from "@polkadot/types/lookup";
...
declare module "@polkadot/api-base/types/events" {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        assetManager: {
            ...
            ForeignAssetTypeChanged: AugmentedEvent<ApiType, [
                assetId: u128,
            ...
            LocalAssetRegistered: AugmentedEvent<ApiType, [
                assetId: u128,
                creator: AccountId20,
                owner: AccountId20
            ], {
        ...
        democracy: {
            ...
            /** An account has cancelled a previous delegation operation. */
            Undelegated: AugmentedEvent<ApiType, [account: AccountId20], {
                account: AccountId20;
            }>;
        ...
        dmpQueue: {
            ...
            MaxMessagesExhausted: AugmentedEvent<ApiType, [
                messageHash: U8aFixed
            ], {
                messageHash: U8aFixed;
            }>;
            ...
            UnsupportedVersion: AugmentedEvent<ApiType, [
                messageHash: U8aFixed
            ], {
                messageHash: U8aFixed;
            }>;
        ...
        parachainStaking: {
            ...
            ParachainBondAccountSet: AugmentedEvent<ApiType, [
                old: AccountId20,
                new_: AccountId20
            ], {
                old: AccountId20;
            ...
            ParachainBondReservePercentSet: AugmentedEvent<ApiType, [
                old: Percent,
                new_: Percent
            ], {
                old: Percent;
            ...
            ReservedForParachainBond: AugmentedEvent<ApiType, [
                account: AccountId20,
                value: u128
            ], {
                account: AccountId20;
